    ...
    return (
      <Layout hideNav>
        <div className="flex flex-col items-center justify-center py-20 px-4">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Commande ma t9atch</h2>
          <Link href="/">
            <Button>Rj3 l accueil</Button>
          </Link>
        </div>
      </Layout>
    );
  ...
  return (
    <Layout hideNav>
      <div className="max-w-2xl mx-auto w-full px-4 py-12 md:py-20 flex flex-col items-center text-center">
        ...
        >
          Merci bzaf, {order.customerName.split(' ')[0]}. Commande dyalk daba kattsalek w ghadi twsl lik qrib.
        </motion.p>
        ...
        <motion.div 
          ...
          className="w-full bg-white border border-gray-100 rounded-3xl p-6 md:p-8 text-left shadow-sm mb-8"
        >
          <div className="flex items-center justify-between border-b border-gray-100 pb-4 mb-4">
            <div>
              <p className="text-xs text-gray-500 font-medium uppercase tracking-wider mb-1">Numero commande</p>
              <p className="font-mono font-bold text-gray-900">#{order.id.toString().padStart(6, '0')}</p>
            </div>
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <p className="font-semibold text-gray-900 mb-1">L3onwan dyal livraison:</p>
          ...
          <div className="bg-gray-50 rounded-2xl p-4">
            <h4 className="text-sm font-bold text-gray-900 mb-3">Produits ({order.items.reduce((acc, i) => acc + i.quantity, 0)})</h4>
